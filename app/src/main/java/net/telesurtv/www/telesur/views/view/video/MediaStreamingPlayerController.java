 ...
 */
public final class MediaStreamingPlayerController extends RelativeLayout implements TelesurPlayerController, TelesurEventsListener, VolumeSeekBar.Listener, BrightnessSeekBar.Listener {
    ...
    public MediaStreamingPlayerController(final Context context) {
        this(context, null);
    }

    public MediaStreamingPlayerController(final Context context, final AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MediaStreamingPlayerController(final Context context, final AttributeSet attrs, final int defStyle) {
    ...
    public void onInitializeAccessibilityEvent(final AccessibilityEvent event) {
        ...
        event.setClassName(MediaStreamingPlayerController.class.getName());
    }

    @Override
    public void onInitializeAccessibilityNodeInfo(final AccessibilityNodeInfo info) {
        super.onInitializeAccessibilityNodeInfo(info);
        info.setClassName(MediaStreamingPlayerController.class.getName());
    }
