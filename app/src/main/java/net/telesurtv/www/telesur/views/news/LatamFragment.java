 ...
 */
public class LatamFragment extends BaseNewsFragment {
    ...
    protected String getSection() {
        return TelesurApiConstants.RSS_LATAM;
    }

    @Override
    protected String getTitleSection() {
        return TelesurApiConstants.SECTION_LATAM;
    }

    @Override
    protected String themeSection() {
        return TelesurApiConstants.THEME_LATAM;
    }
