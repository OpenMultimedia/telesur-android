...
public class SubHeaderView extends LinearLayout {
    ...
    protected void onFinishInflate() {
        ...
        LayoutInflater.from(getContext()).inflate(R.layout.view_toolbar_other, this, true);
        txtTitle = Views.findById(this, R.id.txt_sub_header_title);
        txtAuthor = Views.findById(this, R.id.txt_sub_header_author);
    }
